  ...
  return (
    <div className="w-full py-24 bg-zinc-200">
      <div className="container bg-white flex flex-col lg:flex-row lg:space-x-6 items-center min-h-[600px]">
        ...
        <div className="flex-1 flex items-center justify-center md:justify-start lg:text-left p-4 sm:p-20">
        ...
        {/*div de la imagen */}
        <div className="flex-1 flex justify-center items-center mt-6 md:mt-0 h-[500px] max-w-[500px]">
          {imagen ? (
            <Image
              src={imagen}
              ...
              width={500}
              height={500}
              className="filter sepia-50 brightness-105 saturate-125 border h-full w-full object-cover"
              priority={true}
            />
          ) : (
